...
exports.getCurrentTimeWithDate = exports.getLastNDaysRange = exports.getLastNHoursRange = exports.formatMessageTimestamp = exports.getAttachmentType = exports.isValidEmail = exports.getFileTypeFromUrl = exports.getFileTypeFromName = exports.isSameDate = exports.areObjectsEqual = exports.areArrayEqual = exports.generateRandomString = exports.onlyUnique = exports.uniqueId = void 0;
exports.generateFilename = generateFilename;
exports.generateGreetings = generateGreetings;
...
const timezone_date_conversion_1 = require("./timezone-date-conversion");
...
function generateFilename(blobType) {
    ...
    const uniqueFilename = new Date().getTime() + (0, exports.uniqueId)() + extension;
    return uniqueFilename;
}
function generateGreetings() {
    let currentHour = Number((0, moment_1.default)().format("HH"));
...
const areArrayEqual = (arr1, arr2) => {
    return (0, lodash_1.isEqual)(arr1, arr2);
};
exports.areArrayEqual = areArrayEqual;
...
function truncateDescription(text, maxLength = 100, addEllipsis = true) {
    if (!text)
        return "";
...
function truncateByWords(text, maxWords = 20, addEllipsis = true) {
    if (!text)
        return "";
...
const getFileTypeFromUrl = (url) => {
    try {
        ...
        return (0, exports.getFileTypeFromName)(filename);
    }
    catch (error) {
...
const getAttachmentType = (contentType) => {
...
const formatMessageTimestamp = (date, timeZone) => {
    ...
    const nowDateStr = (0, timezone_date_conversion_1.toLocaleDateStringWithTimezone)(now, timeZone, undefined, {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
    });
    const messageDateStr = (0, timezone_date_conversion_1.toLocaleDateStringWithTimezone)(dateTimestamp, timeZone, undefined, {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
    });
    ...
    const yesterdayDateStr = (0, timezone_date_conversion_1.toLocaleDateStringWithTimezone)(yesterdayDate.getTime(), timeZone, undefined, {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
    });
    const timeStr = (0, timezone_date_conversion_1.toLocaleTimeStringWithTimezone)(dateTimestamp, timeZone, undefined, {
        hour: "2-digit",
        minute: "2-digit",
        hour12: false,
    });
    if (messageDateStr === nowDateStr) {
        ...
        const dateStr = (0, timezone_date_conversion_1.toLocaleDateStringWithTimezone)(dateTimestamp, timeZone, undefined, {
            month: "2-digit",
            day: "2-digit",
            year: "numeric",
        });
 ...
 */
const getCurrentTimeWithDate = (date) => {
    ...
    const result = new Date(dateObj.getFullYear(), dateObj.getMonth(), dateObj.getDate(), currentTime.getHours(), currentTime.getMinutes(), currentTime.getSeconds(), currentTime.getMilliseconds());
    return result.getTime();
};
exports.getCurrentTimeWithDate = getCurrentTimeWithDate;
