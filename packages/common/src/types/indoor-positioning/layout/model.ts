...
// --- Map config (type: "map_config") ---
// Stores map attribution, layer bounds, and zoom-level bounds (e.g. from tile providers).
...
// --- Discriminated union for data ---

export type IndoorPositioningLayoutData =
  | IndoorPositioningLayoutBuilding
  | IndoorPositioningLayoutFloor
  | IndoorPositioningLayoutMapConfig
  | IndoorPositioningLayoutGeofences
  | IntracomLocation;

export type IndoorPositioningLayoutType = "building" | "floor" | "map_config" | "geofences" | "location";

// --- Root document (single collection for buildings, floors, plans) ---
...
export function isBuildingLayout(
  layout: IndoorPositioningLayout
): layout is IndoorPositioningLayout & { type: "building"; data: IndoorPositioningLayoutBuilding } {
  return layout.type === "building";
}

export function isFloorLayout(
  layout: IndoorPositioningLayout
): layout is IndoorPositioningLayout & { type: "floor"; data: IndoorPositioningLayoutFloor } {
  return layout.type === "floor";
}

export function isMapConfigLayout(
  layout: IndoorPositioningLayout
): layout is IndoorPositioningLayout & { type: "map_config"; data: IndoorPositioningLayoutMapConfig } {
  return layout.type === "map_config";
}

export function isGeofencesLayout(
  layout: IndoorPositioningLayout
): layout is IndoorPositioningLayout & { type: "geofences"; data: IndoorPositioningLayoutGeofences } {
