...
export type CoverageStatus =
  | "OPEN"
  | "CLOSED"
  | "STAFFED"      // staffed but not explicitly OPEN/CLOSED in the sheet
  | "UNSPECIFIED"; // extraction couldn't determine
...
export interface PostAssignment {
  ...
  postAnnotation?: string; // e.g. "Event Based", "24 hours", "(0500-2130)"
